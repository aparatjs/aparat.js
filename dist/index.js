...
__export(src_exports, {
  Aparat: () => Aparat,
  BaseApiUrlTypes: () => BaseApiUrlTypes,
...
var AparatEventEmitter = class extends import_events.EventEmitter {
  ...
  async download(hash, quality = "720p" /* P720 */, outputPath = "./video.mp4") {
    try {
      ...
      await new Promise((resolve, reject) => {
        const file = (0, import_fs.createWriteStream)(outputPath);
